				...
				<table class="type05">
					<tbody>
						...
						<tr>
							...
							<td>
								<textarea class="inputTop form-control" style="resize: none;" id="product_info" name="product_info" rows="15" cols="50">${product.product_info }</textarea>
								<input class="inputTop form-control" type="file" name="upload" id="input_imgs" multiple="multiple" accept="image/*" />
							</td>
						</tr>
					</tbody>
				</table>
