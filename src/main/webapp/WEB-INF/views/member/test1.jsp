				...
				<form class="login-form" action="${appRoot }/member/join" method="post">
					...
					<div class="row margin">
						<div class="input-field col s12">
							...
							<button type="button" id="mem-phonecheck-btn" class="btn waves-effect waves-light col s2">확인</button>
					...
					<div class="row margin">
						<div class="input-field col s12">
							<input id="mem-email-input" name="memberMail" type="email" />
							<label for="mem-email-input">이메일</label>
						</div>
					</div>
					
					<div class="row margin">
						<div class="input-field col s12">
							<input id="mem-addnum-input" name="memberAddNum" type="text" /> 
							<label for="mem-addnum-input" id="mem-addnum-label">우편번호</label>
						</div>
					</div>
					
					<div class="row margin">
						<div class="input-field col s12">
							<input id="mem-addcity-input" name="memberAddCity" type="text" />
