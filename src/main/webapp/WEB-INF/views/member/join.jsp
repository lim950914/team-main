...
//글자 수 제한 아이디
	$('#user_id').on("blur keyup", function() {
		...
		if ($(this).val().length < 4 ) {
			$("#idLengthFail").show();
			$("#id-dup-btn").attr("disabled", "disabled");
		} else {
			$("#idLengthFail").hide();
			$("#id-dup-btn").removeAttr("disabled");
		}
	    ...
	    <form class="login-form" action="${appRoot }/member/join" method="post" id="joinForm">
	      <div class="row">
	        ...
	        <div class="input-field col s12">
	          ...
	          <input id="user_id" name="memberId" type="text" maxlength="20"  onKeyUp="checkSpacebar(this);" onpaste="return false;" required/>
	          <button type="button" id="id-dup-btn" class="btn waves-effect waves-light col s3">중복확인</button>
	      ...
	      <div class="row margin">
	        <div class="input-field col s12">
	          ...
	          <input id="user_name" name="memberName" type="text" onKeyUp="checkSpacebar(this);" onpaste="return false;" required/>
	      ...
	      <div class="row margin">
	        <div class="input-field col s12">
	          ...
	          <input id="user_nickname" name="membernickName" type="text" style="cursor: auto;" onKeyUp="checkSpacebar(this);" onpaste="return false;" required />
	      ...
	      <div class="row margin">
	        <div class="input-field col s12">
	          ...
	          <input id="user_password" id="user_password" name="memberPw" type="password" onpaste="return false;" required />
	      ...
	      <div class="row margin">
	        ...
	        <div class="input-field col s12">
	          ...
	          <input id="user_birth" name="memberBirth" type="date" required/>
	        ...
	        <div class="input-field col s12">
	          ...
	          <input id="user_phone" name="memberPhoneNum" type="number" onKeyUp="checkSpacebar(this);" onpaste="return false;" required/>
	      ...
	      <div class="row margin">
	        ...
	        <div class="input-field col s12">
	          ...
	          <input id="user_mail" name="memberMail" type="email" required/>
	      ...
	      <div class="row margin">
	        <div class="input-field col s12">
	          ...
	          <input id="addr" name="memberAddCity" type="text" required/>
	      ...
	      <div class="row margin">
	        <div class="input-field col s12">
	          <!-- <i class="mdi-action-lock-outline prefix"></i> -->
	          <i class="material-icons prefix">home</i>
	          <input id="zipNo" name="memberAddNum" type="text" required/>
	      ...
	      <div class="row">
	        <div class="input-field col s12">
	          <button type="submit" id="btn_add" class="btn waves-effect waves-light col s12">회원가입</button>
	        </div>
	        
	        <div class="input-field col s12">
	          <p class="margin center medium-small sign-up">이미 회원 이신가요?  <a style="color: #666;" href="${appRoot }/member/login">Login</a></p>
	        </div>
	      </div>
	    </form>
    </div>
